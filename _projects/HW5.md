...
For this step I treated the 450 mm lifting bar as an Euler–Bernoulli beam instead of a rigid link.  
Assumptions:
...
Using standard cantilever beam formulas with a point load at C and another at the tip, I estimated the worst-case tip deflection in the mid-stroke position. The total vertical deflection at the tip comes out to only a few millimeters, comfortably below the 9 mm (2% of 450 mm) limit.

## (b) Beam design for < 2% deflection  
To keep deflection under 2% while minimizing mass, I compared several options (solid bar, steel tube, and aluminum tube). A thin-walled aluminum tube gave the best stiffness-to-weight ratio and is easy to manufacture.
